    ...
    public partial class Form1 : Form
    {
            ...
            for(int ax =0; ax< count_elements; ax++)
            {
                for(int bx =0;bx< Iter; bx++)
                {
                    ...
                    else
                    {
                        ...
                        double new_y = GeometricArray[ax, 0] * Math.Sin(0) + GeometricArray[ax, 1] * Math.Cos(0);
                        ResaultGeometric[ax, bx, 0] = new_x;
                        ResaultGeometric[ax, bx, 1] = new_y;
                        ResaultGeometric[ax, bx, 2] = GeometricArray[ax, 2];
                    }
        ...
        private void Draw()
        {
            ...
            if (click % 2 == 0)
            {
                ...
                {
                    rot_1=rot_1+speed;
                    rot_2= rot_2+speed; // очистка буфера цвета и буфера глубины 
                }
            }
            else
            {
